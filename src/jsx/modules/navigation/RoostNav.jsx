...
const RoostNav = React.createClass({
    ...
    render () {
        const {user, mobileTitle, loginOnly, showHome, showLogin, showRegister, registrationEnabled, fontStyle, backgroundStyle, fontHoverStyle, regButtonType} = this.props
        ...
        var nav =
        <nav className={`navbar navbar-default navbar-fixed-top RoostNav ${backgroundStyle} font-${fontStyle} font-hover-${fontHoverStyle}`}>
